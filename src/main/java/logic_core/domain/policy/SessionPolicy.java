...
public class SessionPolicy
{
    ...
    public void validateRefresh(SessionModel oldSession, OffsetDateTime now)
    {
        ...
        SessionModel persistedSession = sessionRepository.findById(sessionId)
        ...
        // We need the user associated with this session to validate refresh
        UserModel user = userRepository.findById(persistedSession.getUserId())
