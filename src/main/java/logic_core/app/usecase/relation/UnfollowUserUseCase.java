...
public class UnfollowUserUseCase
{
    ...
    {
        UUID unfollowerId = currentUserProvider.requireCurrentUserId();
        ...
        FollowRelation followRelation = createFollowRelation(unfollowerId, unfollowedId);
        relationshipRepository.deleteFollow(followRelation);
        ...
        long followingCounts = relationshipRepository.countFollowing(unfollowedId);
        FollowResponse response = FollowMapper.toResponse(false, followingCounts);
